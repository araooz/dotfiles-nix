...
hl.config({
    general = {
        ...
        -- Habilitado para menos input lag en juegos fullscreen
        allow_tearing    = true,
    ...
    decoration = {
        ...
        shadow           = {
            enabled      = false,   -- Desactivado para liberar recursos GPU
        },
        ...
        blur             = {
            enabled  = true,
            size     = 3,
            passes   = 1,       -- Reducido de 3 a 1 para liberar GPU
