...
gesture({
	...
	direction = "up",
	action = function()
		hl.exec_cmd("swayosd-client --playerctl play-pause")
	end,
})
gesture({
	fingers = 3,
...
gesture({
	...
	direction = "up",
	action = function()
		hl.exec_cmd("swayosd-client --output-volume 100")
	end,
})
gesture({
	fingers = 4,
...
gesture({
	...
	direction = "left",
	action = function()
		hl.exec_cmd("swayosd-client --playerctl previous")
	end,
})
gesture({
	fingers = 4,
	direction = "right",
	action = function()
		hl.exec_cmd("swayosd-client --playerctl next")
	end,
})
